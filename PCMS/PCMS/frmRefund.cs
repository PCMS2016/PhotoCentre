...
namespace PCMS
{
    public partial class frmRefund : MetroForm
    {
        ...
        private void tableNames()
        {
            ...
            dgvRefundOrderLines.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dgvRefundOrderLines.Columns[5].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
